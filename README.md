...
SerialPilot 将文件发送作为串口调试工作区的一部分，而不是额外的脚本工具。用户可以选择文件、选择协议并点击发送，在同一个面板中查看传输进度、当前状态和取消操作；发送完成后仍可在 TX 日志中核对实际发送事件。

<!-- 截图占位：请将文件发送截图保存为 docs/images/file-transfer.png 后取消下面一行的注释。 -->
<!-- <p align="center"><img src="docs/images/file-transfer.png" alt="SerialPilot 文件发送" width="820" /></p> -->
...
<!-- 截图占位：请将 MCP 配置或 AI 调用截图保存为 docs/images/mcp-control.png 后取消下面一行的注释。 -->
<!-- <p align="center"><img src="docs/images/mcp-control.png" alt="SerialPilot MCP AI 控制" width="820" /></p> -->

## 截图

项目界面以紧凑的桌面工作区为核心，适合连续接收、对比日志和调试设备状态。

<!-- 截图占位：可在这里补充终端、波形和设置界面截图。 -->
