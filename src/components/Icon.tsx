...
const ICON_PATHS: Record<IconName, JSX.Element> = {
  ...
  settings: <path d="M7.2 2.7h3.6l.45 1.45c.38.16.73.37 1.05.62l1.46-.42 1.8 3.1-1.05 1.1c.03.19.05.38.05.58s-.02.39-.05.58l1.05 1.1-1.8 3.1-1.46-.42c-.32.25-.67.46-1.05.62l-.45 1.45H7.2l-.45-1.45a5.1 5.1 0 0 1-1.05-.62l-1.46.42-1.8-3.1 1.05-1.1a4.2 4.2 0 0 1 0-1.16l-1.05-1.1 1.8-3.1 1.46.42c.32-.25.67-.46 1.05-.62L7.2 2.7ZM9 6.45a2.05 2.05 0 1 0 0 4.1 2.05 2.05 0 0 0 0-4.1Z" />,
