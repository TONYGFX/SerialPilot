...
function FileReceiveProgressCard({ progress, onDismiss, onOpen }: { progress: FileReceiveProgress; onDismiss: () => void; onOpen: () => void }) {
  const finished = progress.completed || progress.cancelled || progress.failed;
